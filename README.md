...
The current public artifact is a 21 September 2026 analytic snapshot. National headlines and the per-health-zone allocation come from visually reviewed INSP SitRep #130, whose report/data clock is 21 September 2026. **SitRep #130 reports 7773 confirmed cases and 3759 confirmed deaths in DRC.** The footprint is **63 of 167 health zones** across seven provinces, with no newly affected zone. Based on the public source package in this repo:
...
- **SitRep #130 splits same-day deaths across community and intra-CTE components.** It advances by 27 confirmed deaths (14 community + 13 intra-CTE) and 40 confirmations. The combined death value closes on cumulative movement; the community-only cover value is a subset.
