...
The current public artifact is an 8 September 2026 analytic snapshot. National headlines and the per-health-zone allocation come from visually reviewed INSP SitRep #117, whose report/data clock is 8 September 2026 and whose official PDF reached insp.cd on 9 September. **SitRep #117 reports 6843 confirmed cases and 3310 confirmed deaths in DRC.** The outbreak's official geography covers 61 of 151 health zones across six DRC provinces, unchanged this cut. Based on the public source package in this repo:

- **6863 confirmed cases** as the current country-scope endpoint in [`data/public_snapshot.json`](data/public_snapshot.json): **6843 DRC + 20 Uganda**. Laboratory-confirmed cases are the only cumulative case metric this snapshot publishes.
- **3312 confirmed deaths** as the country-scope endpoint: **3310 DRC + 2 Uganda**; country-scope recovered is **1622** (**1611 DRC + 11 Uganda**).
- **6863 confirmed cases country-scope, of which 6843 confirmed cases are officially zone-attributed across 61 official source zones** in [`data/public_zone_counts_2026-05-29.csv`](data/public_zone_counts_2026-05-29.csv), using the reviewed INSP per-zone table. The **20 confirmed cases** of source-attribution lag are exactly the separately sourced Uganda anchor. SitRep #117's named zone rows sum exactly to the DRC headline, while its printed 408-death unventilated residual is kept out of mapped health zones.
