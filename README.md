...
- **1909 confirmed cases officially zone-attributed across 40 official source zones** in [`data/public_zone_counts_2026-05-29.csv`](data/public_zone_counts_2026-05-29.csv) are the primary descriptive spread signal. The 1946-case headline leaves **37 confirmed cases unallocated** to a public health-zone row: 17 DRC Ituri confirmed cases are explicitly awaiting health-zone identification in the coherent SitRep #058 Table 2 totals, and 20 Uganda confirmed cases have public country/district reporting but no promoted Uganda health-zone source-load. The five newly-listed Haut-Uele/Tshopo zones are now geolocated and carried as named per-zone rows.
...
For the current contract, the 37 confirmed cases not yet officially zone-attributed are treated as source-attribution lag, not as hidden model redistribution. Confirmed-death attribution retains the 1-3 week trailing-note disclosure; SitRep #058 republishes per-zone confirmed deaths for the coherent 42-zone vector, with only the 17 Ituri confirmed cases held in the explicit unallocated residual. The corridor surface is a descriptive 358-corridor watchlist over the reviewed source-load vector; its adjusted 50% interval ranges span 0.5-95.9% lower and 1.5-100.0% upper, and it is not deployment ranking or a forecast.
