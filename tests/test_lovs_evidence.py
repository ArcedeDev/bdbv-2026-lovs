...
class TestEvidenceChains(unittest.TestCase):
    ...
    def test_default_registry_validates(self):
        ...
        # + SitRep #018/#019/#020/#021/#022/#023/#024/#025 reviewed promotion
        # chains = 27.
        self.assertEqual(summary["supported"], 27)
    ...
    def test_may22_zone_attributed_corridor_chain_is_registered(self):
        ...
        for required in (
            ...
            # unified cascade 569 -> 243 zone-attributed + 326 unallocated across
            # 25 monitored INSP per-zone source zones.
            "569",
            "243",
            "326",
            "25 monitored INSP per-zone source zones",
