...
class TestEvidenceChains(unittest.TestCase):
    ...
    def test_default_registry_validates(self):
        ...
        self.assertEqual(summary["supported"], 87)
    ...
    def test_may22_zone_attributed_corridor_chain_is_registered(self):
        ...
        for required in (
            ...
            # 6542 -> 6522 zone-attributed + 20 unallocated across 61 monitored
            # INSP per-zone source zones (Kayna opens at SitRep #113). The residual
            # is the Uganda country-scope anchor, not a hidden DRC zone residual to
            # smear over the map.
            "6542",
            "6522",
            "20",
            "61 monitored INSP per-zone source zones",
            "547",
            "unallocated",
