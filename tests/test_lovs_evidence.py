...
class TestEvidenceChains(unittest.TestCase):
    ...
    def test_default_registry_validates(self):
        ...
        # + SitRep #018/#019/#020/#021/#022/#023/#024/#025/#026/#027/#028/#030/#031/#032/#033/#034/#035/#036/#041/#042
        # reviewed promotion chains + the reviewed INRB-UMIE per-zone
        # source-review chain = 40 (the SitRep42 reviewed-promotion chain added).
        self.assertEqual(summary["supported"], 40)
    ...
    def test_may22_zone_attributed_corridor_chain_is_registered(self):
        ...
        for required in (
            ...
            "939",
            "36",
            "34 monitored INSP per-zone source zones",
            "304-corridor",
            "unallocated",
