...
class TestConfirmedDeathSeries(unittest.TestCase):
    def test_full_series_values_and_basis(self):
        ...
        # 22 Jun 279, 23 Jun 293, 24 Jun 306. The 26 May base
        ...
        # 247 DRC + 2 UGA = 249. The SitRep37-41 tail extends the confirmed-death
        # history through 24 Jun (#041) at 306 (304 DRC + 2 UGA).
