...
class TestConfirmedDeathSeries(unittest.TestCase):
    def test_full_series_values_and_basis(self):
        ...
        # 9 Jun 129, 10 Jun 138, 11 Jun 141, 13 Jun 183, 14 Jun 194, 15 Jun 198,
        # 16 Jun 204, 17 Jun 234, 18 Jun 247, 19 Jun 249, 20 Jun 256, 21 Jun 269,
        # 22 Jun 279, 23 Jun 293, 24 Jun 306, 25 Jun 323. The 26 May base
        # (17 DRC + 1 UGA = 18) is composed from the
        # manifest. 4 Jun (#021) is 82 DRC + 2 UGA = 84, carrying the refreshed
        # Uganda MoH 6 Jun anchor. 13 Jun (#030) is 181 DRC + 2 UGA = 183. 14 Jun (#031) is 192 DRC + 2 UGA = 194.
        ...
        # 247 DRC + 2 UGA = 249. The SitRep37-54 tail extends the confirmed-death
        # history through 7 Jul (#054) at 602 (600 DRC + 2 UGA); 6 Jul (#053) is
        # 580 DRC + 2 UGA = 582.
