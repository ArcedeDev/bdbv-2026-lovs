...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertEqual(by_section["challenges"], {"inrb-sitrep-114-2026-09-05"})
        self.assertEqual(by_section["highlights"], {"inrb-sitrep-114-2026-09-05"})
        self.assertEqual(by_section["care_continuity"], {"inrb-sitrep-114-2026-09-05"})
        ...
        self.assertIn(
            "DRC: 6604 confirmed and 3175 confirmed deaths",
            text,
        )
        ...
        self.assertIn("24h: 82 confirmations and 41 deaths", text)
        self.assertIn("Contact follow-up eased to 85.7%", text)
        ...
        self.assertEqual(by_section["priorities"], {"inrb-sitrep-114-2026-09-05"})
    ...
    def test_snapshot_clocks_preserve_publication_report_and_retrieval_dates(self):
        ...
        # clock advances with the reviewed SR113 data date.
        self.assertEqual(
            "2026-09-06",
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("6624", by_surface["visibility_module_c"]["input_values"])
        ...
        self.assertIn("3177", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #114",
        ...
        self.assertIn("6604", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("20", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-114-2026-09-05", by_surface["corridor_watchlist"]["blocked_by"])
