...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertTrue(all(row["source_id"] == "inrb-sitrep-077-2026-07-30" for row in rows))
        ...
        self.assertIn(
            "SitRep77 reports 748 patients in isolation (337 confirmed / 411 suspected) "
            "at 71.3% national occupancy",
            text,
        )
        self.assertIn(
            "The DRC headline 3605/1587 closes exactly from 49 detailed zone rows",
            text,
        )
        self.assertIn(
            "The integrated footprint is 49 of 140 health zones across five provinces. "
            "Kabondo is the newly integrated Tshopo zone",
            text,
        )
        ...
        self.assertIn(
            "Apparent positivity is 19.8% over denominator-bearing Ituri and Nord-Kivu rows only",
            text,
        )
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("3625", by_surface["visibility_module_c"]["input_values"])
        ...
        self.assertIn("3625", by_surface["active_queue_projection_c2"]["input_values"])
        self.assertIn(
            "411",
        ...
        self.assertIn("1589", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #077",
        ...
        self.assertIn("3605", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("20", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-077-2026-07-30", by_surface["corridor_watchlist"]["blocked_by"])
