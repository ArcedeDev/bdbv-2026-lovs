...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertEqual(by_section["challenges"], {"inrb-sitrep-108-2026-08-30"})
        self.assertEqual(by_section["highlights"], {"inrb-sitrep-108-2026-08-30"})
        self.assertEqual(by_section["care_continuity"], {"inrb-sitrep-108-2026-08-30"})
        ...
        self.assertIn(
            "National isolation/CTE stock: 814",
            text,
        )
        self.assertIn(
            "DRC: 6100 confirmed and 2950 confirmed deaths",
            text,
        )
        ...
        self.assertIn("24h: 59 confirmations and 39 deaths", text)
        self.assertIn("Contact follow-up is weak in Bas-Uele and Haut-Uele", text)
        ...
        self.assertIn("Improve PoE/PoC operation and reporting completeness", text)
        self.assertEqual(by_section["priorities"], {"inrb-sitrep-108-2026-08-30"})
    ...
    def test_snapshot_clocks_preserve_publication_report_and_retrieval_dates(self):
        ...
        # the manifest; SitRep #108 was published on 2026-08-31 while
        # the analytic data clock remains 2026-08-30.
        self.assertEqual(
            "2026-08-31",
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("6120", by_surface["visibility_module_c"]["input_values"])
        ...
        self.assertIn("2952", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #108",
        ...
        self.assertIn("6100", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("20", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-108-2026-08-30", by_surface["corridor_watchlist"]["blocked_by"])
