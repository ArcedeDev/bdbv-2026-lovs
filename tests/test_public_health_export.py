...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertEqual(by_section["challenges"], {"inrb-sitrep-128-2026-09-19"})
        self.assertEqual(by_section["highlights"], {"inrb-sitrep-128-2026-09-19"})
        self.assertEqual(by_section["care_continuity"], {"inrb-sitrep-128-2026-09-19"})
        ...
        self.assertIn(
            "National isolation/CTE stock: 886",
            text,
        )
        self.assertIn(
            "DRC: 7672 confirmed and 3699 confirmed deaths",
            text,
        )
        ...
        self.assertIn("24h: 58 confirmations and 23 deaths", text)
        self.assertIn("Contact follow-up 26,319/32,958 (79.9%)", text)
        ...
        self.assertEqual(by_section["priorities"], {"inrb-sitrep-128-2026-09-19"})
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("7692", by_surface["visibility_module_c"]["input_values"])
        ...
        self.assertIn("3701", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #128",
        ...
        self.assertIn("7672", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("20", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-128-2026-09-19", by_surface["corridor_watchlist"]["blocked_by"])
