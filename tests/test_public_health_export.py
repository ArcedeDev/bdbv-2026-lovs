...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertEqual(by_section["challenges"], {"inrb-sitrep-119-2026-09-10"})
        self.assertEqual(by_section["highlights"], {"inrb-sitrep-119-2026-09-10"})
        self.assertEqual(by_section["care_continuity"], {"inrb-sitrep-119-2026-09-10"})
        ...
        self.assertIn(
            "National isolation/CTE stock: 837",
            text,
        )
        self.assertIn(
            "DRC: 7022 confirmed and 3398 confirmed deaths",
            text,
        )
        ...
        self.assertIn("24h: 80 confirmations and 49 deaths", text)
        self.assertIn("Contact follow-up is 87.6%", text)
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("7042", by_surface["visibility_module_c"]["input_values"])
        ...
        self.assertIn("3400", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #119",
        ...
        self.assertIn("7022", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("20", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-119-2026-09-10", by_surface["corridor_watchlist"]["blocked_by"])
