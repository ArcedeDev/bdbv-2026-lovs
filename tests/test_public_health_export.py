...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertEqual(by_section["challenges"], {"inrb-sitrep-127-2026-09-18"})
        self.assertEqual(by_section["highlights"], {"inrb-sitrep-127-2026-09-18"})
        self.assertEqual(by_section["care_continuity"], {"inrb-sitrep-127-2026-09-18"})
        ...
        self.assertIn(
            "National isolation/CTE stock: 909",
            text,
        )
        self.assertIn(
            "DRC: 7614 confirmed and 3676 confirmed deaths",
            text,
        )
        ...
        self.assertIn("24h: 73 confirmations and 37 deaths", text)
        self.assertIn("Contact follow-up 26,803/30,541 (87.8%)", text)
        ...
        self.assertIn("PoE/PoC completeness", text)
        self.assertEqual(by_section["priorities"], {"inrb-sitrep-127-2026-09-18"})
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("7634", by_surface["visibility_module_c"]["input_values"])
        ...
        self.assertIn("3678", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #127",
        ...
        self.assertIn("7614", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("20", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-127-2026-09-18", by_surface["corridor_watchlist"]["blocked_by"])
