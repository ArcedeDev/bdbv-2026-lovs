...
class TestPublicHealthDatasetExport(unittest.TestCase):
    ...
    def test_sitrep_narrative_export_carries_reviewed_sitrep_47_sections(self):
        ...
        self.assertTrue(all(row["source_id"] == "inrb-sitrep-053-2026-07-06" for row in rows))
        ...
        self.assertIn("A confirmed case escaped from CT Musienene before transfer to CTE Katwa (Nord-Kivu).", text)
        self.assertIn("237 suspected cases of the day were validated (167 living, 70 community deaths)", text)
        self.assertIn("12190 contacts were under follow-up and 9167 seen", text)
    ...
    def test_snapshot_clocks_preserve_publication_report_and_retrieval_dates(self):
        ...
        # manifest; the SitRep #053 WordPress publication (2026-07-07) is the
    ...
    def test_timeline_exports_c2_per_date_band(self):
        ...
        expected = {
            ...
            ("2026-05-30", "confirmable_active_queue_50_upper"): "404",
            ("2026-05-31", "confirmable_active_queue_50_lower"): "398",
            ("2026-05-31", "confirmable_active_queue_50_upper"): "407",
            ("2026-06-01", "confirmable_active_queue_50_lower"): "447",
            ("2026-06-01", "confirmable_active_queue_50_upper"): "459",
            ("2026-06-09", "confirmable_active_queue_50_lower"): "700",
            ("2026-06-09", "confirmable_active_queue_50_upper"): "705",
            ("2026-06-10", "confirmable_active_queue_50_lower"): "736",
            ("2026-06-10", "confirmable_active_queue_50_upper"): "742",
            ("2026-06-11", "confirmable_active_queue_50_lower"): "764",
            ("2026-06-11", "confirmable_active_queue_50_upper"): "771",
            ("2026-06-13", "confirmable_active_queue_50_lower"): "868",
            ("2026-06-13", "confirmable_active_queue_50_upper"): "877",
            ("2026-06-14", "confirmable_active_queue_50_lower"): "893",
            ("2026-06-14", "confirmable_active_queue_50_upper"): "902",
            ("2026-06-15", "confirmable_active_queue_50_lower"): "922",
            ("2026-06-15", "confirmable_active_queue_50_upper"): "931",
            ("2026-06-16", "confirmable_active_queue_50_lower"): "966",
            ("2026-06-16", "confirmable_active_queue_50_upper"): "975",
            ("2026-06-17", "confirmable_active_queue_50_lower"): "986",
            ("2026-06-17", "confirmable_active_queue_50_upper"): "995",
            ("2026-06-18", "confirmable_active_queue_50_lower"): "1033",
            ("2026-06-18", "confirmable_active_queue_50_upper"): "1043",
            ("2026-06-19", "confirmable_active_queue_50_lower"): "1043",
            ("2026-06-19", "confirmable_active_queue_50_upper"): "1051",
        }
    ...
    def test_analysis_dependency_audit_exports_model_use_and_holdouts(self):
        ...
        self.assertIn("1728", by_surface["visibility_module_c"]["input_values"])
        ...
        # headline (1728) and the active-queue basis is the suspected-in-isolation
        # census (462) once the full active-suspected total stops being published.
        self.assertIn("1728", by_surface["active_queue_projection_c2"]["input_values"])
        self.assertIn(
            "462",
        ...
        self.assertIn("582", by_surface["death_back_projection_and_grid"]["input_values"])
        self.assertIn(
            "SitRep #053",
        ...
        # 2026-07-06 reviewed SitRep53 Table 1: zone-attributed confirmed is
        # 1691, so unallocated headline/cross-border attribution lag is 37.
        self.assertIn("1691", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("37", by_surface["corridor_watchlist"]["input_values"])
        self.assertIn("inrb-sitrep-053-2026-07-06", by_surface["corridor_watchlist"]["blocked_by"])
