...
class BuildTests(unittest.TestCase):
    ...
    def test_build_with_fixtures(self):
        ...
        # (read-only). The current snapshot's analytic as_of is 2026-06-15
        # after the reviewed SitRep #032 endpoint; its latest completed source
        # publication date is 2026-06-16 (SitRep #032 published the day after its
        # 2026-06-15 data cutoff), so a newer completed source publication exists.
        ...
        self.assertEqual(status["analytic_data_date"], "2026-06-15")
