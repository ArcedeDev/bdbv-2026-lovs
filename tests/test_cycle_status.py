...
class BuildTests(unittest.TestCase):
    ...
    def test_build_with_fixtures(self):
        ...
        # (read-only). The current snapshot's analytic as_of is 2026-07-20
        # after the reviewed SitRep #063 endpoint. SitRep #063 (data date
        # 2026-07-20) carries a 2026-07-21 source-publication date, a completed
        ...
        self.assertEqual(status["analytic_data_date"], "2026-07-20")
