...
class BuildTests(unittest.TestCase):
    ...
    def test_build_with_fixtures(self):
        ...
        # (read-only). The current snapshot's analytic as_of is 2026-06-16
        # after the reviewed SitRep #033 endpoint; its latest completed source
        # publication date is 2026-06-16, so no newer completed source publication
        # exists beyond the analytic endpoint.
        ...
        self.assertEqual(status["analytic_data_date"], "2026-06-16")
