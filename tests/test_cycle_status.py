...
class BuildTests(unittest.TestCase):
    ...
    def test_build_with_fixtures(self):
        ...
        # (read-only). The current snapshot's analytic as_of is 2026-07-04
        # after the reviewed SitRep #051 endpoint. SitRep #051 (data date
        # 2026-07-04) was published 2026-07-05 20:26 UTC; a day later the
        # 2026-07-04 data is a completed prior-day source publication, so the
        ...
        self.assertEqual(status["analytic_data_date"], "2026-07-04")
