...
class BuildTests(unittest.TestCase):
    ...
    def test_build_with_fixtures(self):
        ...
        # #130 reports on; the latest completed source publication is already
        # carried by it, so no later completed publication is due.
        self.assertEqual(
        ...
        self.assertEqual(status["analytic_data_date"], "2026-09-21")
