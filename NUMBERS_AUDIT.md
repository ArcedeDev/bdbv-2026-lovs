# Numbers audit, snapshot series through 24 May 2026
...
This file is the **single ground-truth registry** for the dated snapshot series through 24 May 2026. If a downstream number does not appear here, or appears with a different attribution, that is a bug. Update this file in the same commit that updates the number.
...
| Deaths, May 24 | 179 | DRC MoH all-published-bulletins dashboard aggregate registered deaths; CDC Current Situation same-day conflict anchor reports 119 suspected DRC deaths and ten confirmed DRC deaths | drc-moh-epidemie-dashboard-sitrep-009-graphql-2026-05-24; cdc-current-situation-2026-05-24 | DRC MoH dashboard hash-recorded restricted bytes; CDC byte-archived | TrajectoryChart endpoint; AtAGlance deaths; refresh_pipeline.py reported_deaths.primary_value; Audit ref: `ec:lovs:data:bdbv-may24-official-release:2026-05-24` |
...
| May 24 | 179 | round(179 * 1.7003 / 0.40) = 761 | round(179 * 1.7003 / 0.26) = 1171 | current endpoint (snapshot primary; DRC MoH all-published-bulletins aggregate); Audit ref: `ec:lovs:website:cfr-band-correction:2026-05-20`; `ec:lovs:method:death-back-projection:2026-05-21`; `ec:lovs:data:bdbv-may24-official-release:2026-05-24` |
...
The brief Inferred-trajectory paragraph and the InferredTrajectory chart both surface the endpoint band 761-1171 alongside the joint WHO-Imperial reference range 400-900 (Imperial 20 May 2026 update). The two bands are distinct: 761-1171 is this snapshot's own deaths-back-projection at its death count (179, the DRC MoH all-published-bulletins aggregate); 400-900 is Imperial's published envelope over their two methods at their death input (131).
