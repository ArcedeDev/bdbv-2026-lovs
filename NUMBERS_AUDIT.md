...
**Scope note (current cumulative contract).** The rules and per-source rows in this section describe the historical 15-to-25 May reporting series, when suspected was still carried as a published cumulative tier. As of the 2026-07-26 SitRep #073 promotion, the only cumulative epidemiological metrics are laboratory-confirmed cases (3282: 3262 DRC + 20 Uganda) and confirmed deaths (1439: 1437 DRC + 2 Uganda). Confirmed cases close 3200 + 62 = 3262. Deaths close 1405 + 32 = 1437, but the source declares a minus-two Nord-Kivu death harmonization, so +32 is a net notification/reclassification value rather than pure incident mortality. The cumulative suspected tier and confirmed-and-suspected composite remain archived from the headline. Suspected cases appear only as point-in-time operational caseloads on a separate axis. SitRep #073 reports 723 patients in isolation at 76.8% occupancy; 681 J-1 + 126 admissions - 84 exits = 723 and 325 confirmed + 398 suspected = 723. The under-investigation stock and total active suspected queue are not fabricated.
...
The 430-corridor watchlist is emitted from the INSP per-health-zone surface: 48 official source zones crossed with nine candidate targets, minus the goma-cod and beni-cod self-edges. The roster is unchanged at SitRep #073. For the 2026-07-26 snapshot, adjusted 50% ranges span 0.5-99.2% lower and 1.5-100.0% upper; bunia -> beni-cod ranks first at 98.9-100.0%. The country headline is 3282 confirmed cases (3262 DRC + 20 Uganda); 3262 confirmed cases are officially zone-attributed, while the 20 confirmed cases remain explicit Uganda source-attribution lag. The detailed rows support Haut-Uele 39/21 and close to 3262/1437; page 2's Haut-Uele 38 is preserved as a typo. The death movement contains a declared minus-two harmonization and is not interpreted as pure incident mortality. Audit refs: `ec:lovs:method:bdbv-zone-attributed-corridors:2026-05-22`; `ec:lovs:data:inrb-sitrep-073-visual-promotion:2026-07-26`. Numbers below remain the pre-committed calibration corridors and are not re-derived from future rankings.
