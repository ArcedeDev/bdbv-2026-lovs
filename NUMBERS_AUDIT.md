...
| May 22 | 177 | round(177 * 1.7003 / 0.40) = 752 | round(177 * 1.7003 / 0.26) = 1158 | current endpoint (snapshot primary; highest valid primary, WHO DG 22 May); Audit ref: `ec:lovs:website:cfr-band-correction:2026-05-20`; `ec:lovs:method:death-back-projection:2026-05-21` |
...
The brief Inferred-trajectory paragraph and the InferredTrajectory chart both surface the endpoint band 752-1158 alongside the joint WHO-Imperial reference range 400-900 (Imperial 20 May 2026 update). The two bands are distinct: 752-1158 is this snapshot's own deaths-back-projection at its death count (177, the higher valid primary from WHO DG 22 May); 400-900 is Imperial's published envelope over their two methods at their death input (131).
