...
| Confirmed cases, May 24 | 106 confirmed cases | CDC Current Situation: 101 confirmed in DRC plus 5 confirmed in Uganda. Same-day DRC MoH dashboard aggregate reports 112 confirmed DRC cases and is retained as official conflict evidence. | cdc-current-situation-2026-05-24; drc-moh-epidemie-dashboard-sitrep-009-graphql-2026-05-24 | CDC page byte-archived, SHA-256 `b33e81ab...`; DRC MoH dashboard GraphQL hash-recorded, SHA-256 `f3d51491...` | TrajectoryChart May 24 point; conflict anchor (superseded by CDC 25 May 112); Audit ref: `ec:lovs:data:bdbv-may24-official-release:2026-05-24` |
| Confirmed cases, May 25 | 112 confirmed cases | US CDC Current Situation: 105 confirmed in DRC plus 7 confirmed in Uganda, the highest valid primary on the latest date. ECDC 25 May reports 101 confirmed; the DRC MoH 24 May dashboard aggregate reports 112 confirmed DRC cases (different DRC-only composition). Both are dated conflict anchors. | cdc-current-situation-2026-05-25; ecdc-bdbv-drc-uga-2026-05-25-live | CDC page byte-archived, SHA-256 `77d396c0...`; ECDC byte-archived, SHA-256 `0636fc9b...` | TrajectoryChart endpoint; AtAGlance confirmed; refresh_pipeline.py reported_counts.confirmed.primary_value; Audit ref: `ec:lovs:data:bdbv-may25-official-release:2026-05-25` |
...
| Suspected/reported cases, May 25 | 906 | US CDC Current Situation DRC suspected count, the highest valid primary on the latest date. ECDC 25 May reports 904 suspected; the DRC MoH 24 May aggregate reports 854 reported cases. Both are dated conflict anchors. | cdc-current-situation-2026-05-25; ecdc-bdbv-drc-uga-2026-05-25-live | CDC byte-archived, SHA-256 `77d396c0...`; ECDC byte-archived, SHA-256 `0636fc9b...` | TrajectoryChart endpoint; AtAGlance suspected; refresh_pipeline.py reported_counts.suspected.primary_value; Audit ref: `ec:lovs:data:bdbv-may25-official-release:2026-05-25` |
...
| Deaths, May 25 | 223 | US CDC Current Situation: 223 suspected DRC deaths, the highest valid primary on the latest date and the reported endpoint. ECDC 25 May reports 119 suspected deaths; the DRC MoH 24 May aggregate reports 179 registered deaths. Both are dated conflict anchors. CDC also reports ten confirmed DRC deaths and one Uganda death. | cdc-current-situation-2026-05-25; ecdc-bdbv-drc-uga-2026-05-25-live; drc-moh-epidemie-dashboard-sitrep-009-graphql-2026-05-24 | CDC byte-archived, SHA-256 `77d396c0...`; ECDC byte-archived, SHA-256 `0636fc9b...` | TrajectoryChart endpoint; AtAGlance deaths; refresh_pipeline.py reported_deaths.primary_value; Audit ref: `ec:lovs:data:bdbv-may25-official-release:2026-05-25` |
...
| May 25 | 223 | round(223 * 1.7003 / 0.40) = 948 | round(223 * 1.7003 / 0.26) = 1458 | current endpoint (snapshot primary; US CDC Current Situation 25 May suspected DRC deaths, highest valid primary); Audit ref: `ec:lovs:website:cfr-band-correction:2026-05-20`; `ec:lovs:method:death-back-projection:2026-05-21`; `ec:lovs:data:bdbv-may25-official-release:2026-05-25` |
...
The brief Inferred-trajectory paragraph and the InferredTrajectory chart both surface the endpoint band 948-1458 alongside the joint WHO-Imperial reference range 400-900 (Imperial 20 May 2026 update). The two bands are distinct: 948-1458 is this snapshot's own deaths-back-projection at its death count (223, US CDC Current Situation 25 May suspected DRC deaths); 400-900 is Imperial's published envelope over their two methods at their death input (131).
