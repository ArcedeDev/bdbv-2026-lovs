...
The 493-corridor watchlist is emitted from the latest reviewed INSP per-health-zone surface: 55 official SitRep #091 source zones crossed with nine candidate targets, minus the goma-cod and beni-cod self-edges. For the 2026-08-13 snapshot, adjusted 50% ranges span 0.5-99.9% lower and 1.5-100.0% upper. The country headline is 4747 confirmed cases (4727 DRC + 20 Uganda), while 4727 confirmed cases are officially zone-attributed on the 2026-08-13 clock; the residual 20 confirmed cases are exactly the separately sourced Uganda anchor. SitRep #091 republishes the full per-health-zone table after the compact #084/#085 editions and the #086/#087 LinkedIn image packets carried none, so DRC zone attribution is current with the DRC headline; Buta and the Tshopo health zone are served as their own GRID3 geometries rather than shaded onto neighbours. Audit refs: `ec:lovs:method:bdbv-zone-attributed-corridors:2026-05-22`; `ec:lovs:data:inrb-sitrep-090-visual-promotion:2026-08-12`; `ec:lovs:data:inrb-sitrep-091-visual-promotion:2026-08-13`. Numbers below remain the pre-committed calibration corridors and are not re-derived from future rankings.
