...
| Confirmed cases, May 22 | 84 | WHO Director-General Member State briefing: 82 confirmed in DRC plus 2 imported Uganda cases | who-dg-remarks-bdbv-2026-05-22 | byte-archived, SHA-256 `40367f29...`; official aggregate endpoint, not zone-attributed line-list data | TrajectoryChart endpoint; AtAGlance confirmed; refresh_pipeline.py reported_counts.confirmed.primary_value; Audit ref: `ec:lovs:data:bdbv-may22-official-release:2026-05-22` |
...
| Suspected cases, May 22 | almost 750 | WHO Director-General Member State briefing | who-dg-remarks-bdbv-2026-05-22 | byte-archived, SHA-256 `40367f29...`; normalized numeric endpoint stored as 750 with approximate semantics | TrajectoryChart endpoint; AtAGlance suspected; refresh_pipeline.py reported_counts.suspected.primary_value; Audit ref: `ec:lovs:data:bdbv-may22-official-release:2026-05-22` |
...
| Deaths, May 22 | 177 suspected deaths | WHO Director-General Member State briefing | who-dg-remarks-bdbv-2026-05-22 | byte-archived, SHA-256 `40367f29...` | TrajectoryChart endpoint; AtAGlance deaths; refresh_pipeline.py reported_deaths.primary_value; Audit ref: `ec:lovs:data:bdbv-may22-official-release:2026-05-22` |
...
| Kinshasa reported case | 0 confirmed | WHO PHEIC update: reported Kinshasa case tested negative on confirmatory INRB testing and is not counted as confirmed | who-pheic-2026-05-17 | byte-archived | zones.json kinshasa-cod audit note; tools/sync_to_website.py contextNote; Audit ref: `audit_gap:public-source-row` |
...
The brief Inferred-trajectory paragraph and the InferredTrajectory chart both surface the May-22 endpoint band 752-1158 alongside the joint WHO-Imperial reference range 400-900 (Imperial 20 May 2026 update). The two bands are distinct: 752-1158 is this snapshot's own deaths-back-projection at its death count (177); 400-900 is Imperial's published envelope over their two methods at their death input (131).
